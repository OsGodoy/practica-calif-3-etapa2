...
export default function Header({ setIsToggleNavegator }) {
  return (
    <nav className="p-4 bg-gradient-to-l from-blue-100 to-white w-full sticky top-0 flex items-center justify-between z-[100]">
      <Link to="/">
        <img
      ...
      <div className="flex items-center justify-center gap-2">
        <nav className="text-sm hidden md:flex w-120 items-center justify-between">
        ...
        <section className="gap-2 flex items-center justify-center">
          <button className="md:p-1 md:bg-gradient-to-br from-fuchsia-300 to-blue-500 rounded-full">
            <svg

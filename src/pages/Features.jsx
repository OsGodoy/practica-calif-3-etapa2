...
export default function Features() {
  return (
    <>
      <div className="w-full h-140 md:h-75 lg:h-100 xl:h-230 py-4 gap-4 lg:gap-12 bg-gradient-to-br from-fuchsia-300/10 to-blue-500/10 flex flex-col items-center justify-center">

  ...
  return (
    <>
      <section className="flex flex-col items-center justify-end h-140 w-full bg-auto bg-no-repeat bg-[url(/images/1.home/illustration1.png)] sm:bg-right-top">
        <div className="p-4 gap-1 flex flex-col items-center justify-center">
          ...
          <p className="text-center text-sm text-slate-500 leading-4">
      ...
      <section className="h-60 w-80 p-4 px-4 gap-4 flex flex-col justify-center">
        <div className="h-[2px] w-full bg-gradient-to-r from-transparent via-blue-100 to-transparent"></div>
        <div className="grid grid-cols-6 px-1 py-8 gap-2 place-items-center">
          <img

...
export default function Services() {
  return (
    <>
      <div className="w-screen lg:h-210 py-4 gap-4 lg:gap-12 bg-gradient-to-br from-fuchsia-300/10 to-blue-500/10 flex flex-col items-center justify-center">
        <img 
        className="hidden sm:flex absolute size-50 bottom-[65%] lg:bottom-[55%] left-0 lg:left-[0%] xl:left-[10%] 2xl:left-[20%]"
        src="./images/2.services/illustration1.png" alt="" />
